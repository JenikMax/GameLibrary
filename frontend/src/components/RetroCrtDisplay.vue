<template>
  <div class="retro-crt-wrapper">
    <svg viewBox="0 0 340 200" xmlns="http://www.w3.org/2000/svg" class="retro-crt-svg" stroke-linecap="round" stroke-linejoin="round">
      <rect x="85" y="15" width="170" height="170" rx="8" stroke="#00ff88" fill="#003d22" />
      <rect x="100" y="28" width="140" height="120" rx="4" stroke="#00ff88" fill="#002a18" />
      <rect x="105" y="33" width="130" height="110" rx="3" stroke="none" fill="rgba(0,255,136,0.06)" />
      <text v-for="(line, i) in screenLines" :key="i"
        :x="line.x || 115" :y="line.y || 50 + i * 14"
        :font-size="line.size || 6"
        :stroke="line.color || '#00ff88'"
        :fill="line.color || '#00ff88'"
        :opacity="line.opacity ?? (line.isCursor ? 0.9 : 0.6)"
        font-family="monospace">{{ line.text }}</text>
      <!-- cursor blink -->
      <text x="115" y="144" font-size="7" stroke="#00cc6a" fill="#00cc6a" opacity="0.9" font-family="monospace" class="crt-cursor-text">_</text>
      <!-- bottom controls -->
      <rect x="100" y="158" width="15" height="8" rx="2" stroke="#00ff88" fill="none" />
      <rect x="120" y="158" width="15" height="8" rx="2" stroke="#00ff88" fill="none" />
      <circle cx="230" cy="162" r="5" stroke="#00ff88" fill="none" />
      <line x1="230" y1="160" x2="230" y2="164" stroke="#00ff88" opacity="0.5" />
    </svg>
